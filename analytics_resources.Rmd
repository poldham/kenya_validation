...
When you have registered and downloaded Github Desktop try Cloning this repository:
[https://github.com/poldham/kenya_validation](https://github.com/poldham/kenya_validation)
...
If you would like to become a collaborator on a project (say the Kenya_validation folder) then Submit New Issue and request to make a collaborator. As the repo owner I will then add you (but you must have a Github Account). 
...
The electronic book version of the Manual is here: https://wipo-analytics.github.io/
You can download any of the repositories (folders) by logging in to Github selecting a repository and choosing CLONE.  The files can then be opened in RStudio (below)
The chapters you will find interesting are: 

1. Tableau – for dashboarding. See this chapter to learn how to do it: [https://wipo-analytics.github.io/tableau-public-2.html](https://wipo-analytics.github.io/tableau-public-2.html)
For self-learning you can download any of my workbooks (including data for Kenya) here:  [https://public.tableau.com/profile/poldham](https://public.tableau.com/profile/poldham). 

For other examples try the Gallery [https://public.tableau.com/en-us/s/gallery](https://public.tableau.com/en-us/s/gallery)

2. Network analysis with Gephi. This chapter needs updating as it uses an older (v8) version of Gephi (now version 9). Version 9 lacked key features but has now been fixed. So try following with version 9 and I will update during May. 
[https://wipo-analytics.github.io/gephi-1.html](https://wipo-analytics.github.io/gephi-1.html) 

3. Data Cleaning, You can do a lot of data cleaning with Open Refine. 
[https://wipo-analytics.github.io/open-refine.html](https://wipo-analytics.github.io/open-refine.html)

4. Infographics
Now very popular for reports etc… try this walkthrough: 
[https://wipo-analytics.github.io/patent-infographics-with-r.html](https://wipo-analytics.github.io/patent-infographics-with-r.html)

My WIPO colleague Irene Kitsara now leads on infographics and is much better than I am at it. 
Irene’s training presentation is here: 
[https://github.com/wipo-analytics/presentations/blob/master/Topic_15%20Creating%20Infographics.pdf](https://github.com/wipo-analytics/presentations/blob/master/Topic_15%20Creating%20Infographics.pdf) 

###The Handbook on ABS Monitoring

This is a work in progress using data for Kenya. 
The Handbook Website is here: [https://poldham.github.io/abs/](https://poldham.github.io/abs/)
The repository for the website is here: [https://github.com/poldham/abs](https://github.com/poldham/abs)
...
The model for the permit system is here: [http://abspermits.net/](http://abspermits.net/)
The Github repository for the website is here: 
[https://github.com/poldham/abs_permits](https://github.com/poldham/abs_permits)
...
A quick guide to installing R and RStudio is here: 
[https://poldham.github.io/abs/gettingstarted.html](https://poldham.github.io/abs/gettingstarted.html)
...
1. Data Camp: [https://www.datacamp.com/](https://www.datacamp.com/)
...
3. R-bloggers is great for walkthroughs:  [https://www.r-bloggers.com/](https://www.r-bloggers.com/)
